...
const AdminFooter = () => {
  return (
    <div className="bg_footer">
      <div className="bg_footer_content">
        <div className="container">
          <div className="row ">
            <div className="footer_logo footer_box col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 pt-5 pb-5">
            ...
            <div className="footer_nav footer_box col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12 p-5 ">
            ...
            <div className="footer_social footer_nav footer_box col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 pt-5 pb-5">
              <div className="social_box nav_box">
                <ul className="d-flex aling-items-center flex-wrap ">
                  <li>
                    <a
                      href="https://www.facebook.com/vicearmory"
                      className="facebook"
                      target="_blank"
                    >
                      <svg
                      ...
                      >
                        <g id="facebook" transform="translate(-1034 -4441)">
                          <path
                            id="Background"
                            d="M20.5,41A20.5,20.5,0,1,0,0,20.5,20.5,20.5,0,0,0,20.5,41Z"
                            transform="translate(1034 4441)"
                            fill="#fff"
                          />
                          <path
                            id="Facebook_Icon"
                            ...
                            transform="translate(1051.571 4457)"
                            fill="#080809"
                          />
                        </g>
                      </svg>
                  ...
                  <li>
                    <a
                      href="https://www.instagram.com/vicearmory/"
                      className="insta"
                      target="_blank"
                    >
                      <svg
                      ...
                      >
                        <g id="insta" transform="translate(-1100 -4441)">
                          <path
                            id="Background"
                            d="M22.5,45A22.5,22.5,0,1,0,0,22.5,22.5,22.5,0,0,0,22.5,45Z"
                            transform="translate(1100 4441)"
                            fill="#fff"
                          />
                          <g
                            id="instagram_1"
                            data-name="instagram 1"
                            transform="translate(1115 4455)"
                          >
                            <g id="Group">
